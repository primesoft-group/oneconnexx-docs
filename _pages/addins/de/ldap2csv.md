...
| properties | Die zu exportierende Spalten, durch , getrennt.<br />Domänenattribute starten mit $ (Beispiel: $maxPwdAge).<br/>Datentyp, Format und CSV-Spaltenname können durch # getrennt angefügt werden (Bsp. "$DomänenAttribut#date#yyyy-MM-dd#Spaltenname")<br/>Datentyp: "date", "ticks"<br/>Format: Datumsformat als .NET String-Format Ausdruck, nur für Datentyp "date" (z.B. "dd.MM.yyyy" oder "yyyMMddHHmmss") |
