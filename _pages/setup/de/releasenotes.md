...
* __Neu__ FileCopy Add-In: Unterstützung für den Upload grosser Dateien (>240 MB) via Graph API auf SharePoint.
...
* __Fehler__ SharepointEraser Add-In: Support für mehr als 200 Dateien in Sharepoint.
